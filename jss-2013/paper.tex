...
% CHANGE #3. It was already here, I mentioned again in the next section
...
\begin{thebibliography}{38}
	...
	K. Beck, \emph{Test-Driven Development By Example}, 1st~ed.\hskip 1em plus 0.5em
	  minus 0.4em\relax Addison-Wesley Professional, 2002.

	\bibitem{wambler-survey-agile}
	Ambler, S., ``How agile are you? 2010 survey results,''
	  \url{http://www.ambysoft.com/surveys/howAgileAreYou2010.html}, 2010, Last access on November, the 28th, 2010.
	...
	V.~One, ``State of agile development survey results,''
	  ...
	  Last access on February, the 29th, 2012.
	...
	\bibitem{GOOS}
	S. Freeman., N. Pryce, \emph{Growing Object-Oriented Software, Guided by Tests},
	...
	M.~Aniche, T.~Ferreira, and M.~Gerosa, ``What concerns beginner test-driven
	  ...
	  conference,'' 1st Brazilian Workshop on Agile Methods (WBMA), 2011.
	...
	J.~Langr, ``Evolution of test and code via test-first design,''
	  \url{http://www.objectmentor.com}, 2001, Last access on March, the 1st, 2011..
	...
	\bibitem{meszaros}
	G.Mezsaros, ``xUnit Test Patterns: Refactoring Test Code,'' Addison-Wesley, 2007.
	...
	M.~Josefsson, ``Making architectural design phase obsolete - tdd as a design
	  ...
	  University of Technology. Last access on March, the 1st, 2011.
	...
	\bibitem{mocks}
	T. Mackinnon, S. Freeman, ``Endotesting: unit testing with mock
	...
	\bibitem{gof}
	E. Freeman, E. Freeman, B. Bates, K. Sierra, E. Robson, \emph{Head First Design Patterns},
	...
	M.~Feathers, ``The deep synergy between testability and good design,''
	  ...
	  2007, Last access on November, the 27th, 2012.
