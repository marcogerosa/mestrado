...
brasileiro serão selecionados. Todos eles serão solicitados a resolver 
alguns problemas utilizando Java, dentro de um período de tempo limitado. 

Os participantes serão solicitados a utilizar TDD em um problema, e a não utilizar
TDD no outro. Os problemas resolvidos bem como em qual deles o participante
deverá utilizar TDD será randomizada, afim de diminuir o problema do aprendizado.

Todas as implementações feitas serão salvas, para que o pesquisador tenha a possibilidade
de calcular métricas de código sob elas. Ao final do exercício, todos participantes
também responderão um questionário, sobre seu desempenho na resolução dos problemas.

Em seguida, uma análise inicial servirá para filtrar os candidatos
...
Entrevistas tendem a ser úteis já que os participantes podem prover dados históricos 
sobre o objeto em estudo.
Além disso, entrevistas permitem ao pesquisador o controle sobre as questões a serem feitas.
...
\begin{itemize}
	...
	em desenvolvimento de software quanto em TDD, deve-se entender por que
	...
	a prática ajude na qualidade do código. Caso isso não aconteça, deve-se 
...
Todos os participantes serão convidados a resolver os exercícios pré-preparados. 
Para que isso aconteça sem maiores problema, o pesquisador criará um caderno
de exercício na qual o participante deverá segui-lo, que pode ser encontrado
...
O tempo é considerado suficiente para que o participante resolva todos eles. 
...
O participante receberá 2 exercícios. Em 1, o participante deverá praticar TDD; no outro,
ele deverá programar sem a prática. A razão disso
...
Cada participante receberá instruções claras no caderno de exercícios 
...
\begin{enumerate}
	\item Como você avalia a clareza do exercício?
	\item Como você avalia o tempo que teve para resolver os exercícios?
...
\begin{enumerate}
	\item Qual sua opinião em relação a qualidade do código gerado?
	\item O que você faz para manter seu código com alta qualidade?
	\item Em relação ao design das classes que você criou, como eles surgiram? O que você fez para avaliar a 
	qualidade do design gerado? Explique sua resposta.
\end{enumerate}
...
\begin{enumerate}
	\item Durante os exercícios nos quais deveria-se utilizar TDD, como você avalia a maneira com que praticou? Usou a prática o 
	tempo todo, sempre escreveu um teste antes de implementar, e tentou ser o mais simples possível?
	\item A prática de TDD fez alguma diferença no código final gerado? Quais? Como? Explique sua resposta.
	\item Você resolveu exercícios com e sem a prática de TDD. Em relação ao processo de criação do design, você percebeu alguma
	diferença ao praticar TDD? Qual? Explique sua resposta.
	\item Será que TDD é realmente necessário ou basta apenas o desenvolvedor usar a sua experiência? Explique sua resposta.
	\item Em sua opinião, os desenvolvedores devem usar TDD? Por que?
\end{enumerate}
