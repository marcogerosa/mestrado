...
\section{Análise do Código-Fonte}
...
Na Tabela \ref{tab:metricas-industria}, mostramos os \textit{p-values} encontrados para
...
\begin{table}
	\begin{tabular}{ | p{5cm} | c | c | c | c | c |}
		\hline
		Exercício & Complexidade ciclomática & Acoplamento eferente & Falta de coesão dos métodos & Número de linhas por método 
...
\begin{table}
	\begin{tabular}{ | p{5cm} | c | c | c | c | c |}
		...
		\hline
			total	0.254	&	0.007676* & 0.351 & 0.2668 & 0.1706\\
		\hline
	\end{tabular}
	\label{tab:metricas-academia}
...
\begin{table}
	\begin{tabular}{| p{5cm} | c | c | c | }
		...
		Especislista 2	& 0.88	& 0.5519 &	0.88\\
		\hline
	\end{tabular}
