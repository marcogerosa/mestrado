...
\begin{center}
    \vspace*{2.3cm}
    \textbf{\Large{Influência de Desenvolvimento Guiado pelos Testes nas Decisões de Projeto de Classes \\
...
como DGT influencia nas decisões de projeto tomadas por um desenvolvedor durante o
...
prática e os catalogou. Esses padrões encontrados podem ser muito úteis para desenvolvedores
que queriam encontrar maneiras de validar o projeto de classes em desenvolvimento.
