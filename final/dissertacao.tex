...
\begin{center}
    ...
    Orientador: Prof. Dr. Marco Aurélio Gerosa
   	...
   	\vskip 1.5cm
    \normalsize{São Paulo, agosto de 2011}
\end{center}
...
\input cap-motivacao
\input cap-tdd
\input cap-mistakes-tdd
\input cap-design
\input cap-trabrelacionados
\input cap-quali-planejamento
\input cap-findings
\input cap-ameacas
\input cap-estudo-mack
\input cap-estudo-asserts
...
\include{ape-entrevista}
\include{ape-slides-mack}
\include{ape-slides-workshop}
