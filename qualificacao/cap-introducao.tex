...
inserido, este trabalho é um estudo de caso sobre como diferentes desenvolvedores, 
atuantes em empresas do mercado brasileiro de software que já utilizam TDD normalmente
dentro do seu ciclo de desenvolvimento, utilizam a prática para guiar o design de classes. 
...
Tendo como premissa que TDD tem uma influência positiva na qualidade
do código final produzido, 
...
Mais profundamente, o objetivo desta pesquisa é entender como TDD influencia essas decisões 
sob vários pontos de vista diferentes, como acoplamento, coesão e simplicidade. 
...
Os objetivo principal da pesquisa é \textbf{entender como TDD influencia no
