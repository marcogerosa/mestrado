...
grafo de causa-efeito \cite{art-of-sw-testing}, e portanto \texit{não é uma prática de testes de software}.
...
seria criar uma classe TabelaDeMortalidade, que recebe uma \texit{Pessoa} como parâmetro. O código seria algo como:
