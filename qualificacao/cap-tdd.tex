...
Uma solução para isso é enxergar os testes criados pela prática de TDD como uma documentação; mas uma documentação que é "executável", já que o programador
pode rodá-la e verificar se está tudo correto.
