...
linguagem Java. Participantes que praticarão TDD utilizarão JUnit para a escrita de testes
...
% TODO explicar o pq isso eh recorrente
...
esperado: implementacao parecida com observer, cada acao em uma classe
nao esperado: god class

3o exercicio: processador de boletos
-> processador de boletos que deve marcar a fatura como paga, caso a soma de boletos pagos seja maior ou igual ao valor da fatura.

esperado: método que marca a fatura como paga dentro da classe Fatura
nao esperado: intimidade inapropriada

4o exercicio: quebra-cabeca numerico
-> simples quebra-cabeca numerico com uma saida impressa complicada

esperado: codigo simples no quebra-cabeca e formatador em outra classe
nao esperado: classe unica com codigo complicado
...
O objetivo das perguntas abaixo é obter a visão do desenvolvedor sobre o próprio código gerado e como ele
faz para obter feedback sobre a qualidade do código que escreve. Também serão feitas para todos os grupos:

\begin{enumerate}
	\item Você acha que o código que você gerou é de fácil manutenção? Explique sua resposta.
	\item Durante a implementação, que práticas você adota para obter sempre um design flexível e elegante? E por que a adota?
...
\begin{enumerate}
	...
	\item Por que seguiu o ciclo o tempo? Isso faz alguma diferença no design final?
...
Qualidade do código gerado é algo difícil de ser medido. Para isso, será utilizada
a opinião de um especialista e o código será categorizado em "Bom", "Médio" ou "Ruim"
de acordo com critérios como adesão a princípios SOLID e simplicidade.
