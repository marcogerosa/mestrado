...
% TODO: doutorado do janzen ele tambem percebeu que desenvolvedores maduros uam
% melhor a pratica. texto abaixo pronto:
%A tese de doutorado de Janzen foi inconclusiva no que diz respeito à influência
%de TDD no acoplamento e na coesão \cite{janzen-phd}.
% TODO exemplo de artigo com metrica mal usada A Comparative Case Study on the
% Impact of Test-Driven Development on Program Design and Test Coverage

% TODO melhor design por causa da simplicidade The effectiveness of test-driven
% development: an industrial case study. alem disso, uma bateria de testes de
% regressao que permitem o dev refatorar

% TODO: Madeyski nao conseguiu mostrar grande diferenca entre TDD e Pair
% Programming ou a combinacao deles ao discutir dependencias entre pacotes. Ao
% combinar resultados, encontrou que TDD pode ter ajuda apenas no nível de
% classes. segundo ele, O programador deve usar TDD mas ficar espero com
% problema de design. (The Impact of Pair Programming and Test-Driven
% Development on Package Dependencies in Object-Oriented Design — An Experiment)

% TODO em software livre, codigo com TDD diminui numero de problemas, mas em
% compensacao a produtividade caiu quando TDD foi adotado completamente
% (Introducing TDD on a Free Libre Open Source Software Project: a Simulation Experiment)

% . The studies that are supporting TDD are based on very limited experiment
% setups and therefore cannot be generalized in a sensible way. Muito a ser
% feito, The claimed effect that TDD should have on the quality of design cannot
% be proven right with the present studies. (Making Architectural Design Phase
% Obsolete – TDD as a Design Method)

% TODO estudantes que aprnedem tdd falharam menos no curso, e empregadores
% perceberam essa melhora (Test-Driven Design for Introductory OO Programming)

% TODO: citar body of evidence e madeyski
...
% TODO: tabela comparando todos eles
