...
\begin{center}
    \vspace*{2.3cm}
    \textbf{\Large{Um estudo sobre o Impacto de Test-Driven Development na Qualidade do Design de Classes}}\\
...
\begin{tabular}{ll}
         TDD         & Desenvolvimento Guiado por Testes (\emph{Test-Driven Development})\\
