...
Quebras do príncipio de Liskov geralmente levam o programador a quebrar o
...
classes mais estáveis do que ela própria \cite{bobmartin-stability}.

% TODO colocar a figura 28-5 e 28-6 do livro do bob martin para exemplificar
% modulos estaveis e instaveis
...
\textit{Linha Principal} \cite{bobmartin-stability}.

% TODO colocar figura da instabilidade e relacionar acima
