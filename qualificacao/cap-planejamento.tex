...
Para entendê-las, este trabalho propõe uma pesquisa qualitativa com 
...
inserido, este trabalho pode ser classificado como um estudo etnográfico. 
O objetivo de uma pesquisa
etnográfica é obter uma imagem completa dos sujeitos sob estudo, dando ênfase
às experiências que passam em seu dia-a-dia de trabalho \cite{creswell}. 
...
Para a condução do estudo etnográfico, desenvolvedores de algumas empresas do mercado de 
