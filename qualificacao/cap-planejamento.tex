...
Ao final, todos deverão responder a um questionário online, que conterá perguntas sobre a qualidade
...
\begin{table}[h!]
	\begin{tabular}{ | p{2cm} | p{5cm} | p{7cm} |}
		...
		A & Participantes que praticaram TDD e tiveram bons resultados
		& 
		...
		B & Participantes que praticaram TDD e não tiveram bons resultados 
		&
...
pertence a cada código-fonte analisado.
