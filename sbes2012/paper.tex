...
\begin{abstract} 
	...
	Extrema. Apesar de soar como uma prática de testes de software, muitos autores de livros 
	conhecidos pela indústria e academia afirmam que a prática pode influenciar no projeto de classes.
...
Os valores apresentados acima corroboram com muitos dos estudos
apresentados anteriormente. Aparentemente TDD não influencia no projeto de classes.
Mas, conforme já previsto, é necessário um estudo qualitativo para 
entender os reais efeitos da prática no projeto de classes.
...
Como discutido no capítulo \ref{sec:planejamento}, o pesquisador possui
