...
Mesmo os próprios praticantes não entendem ou conseguem expressar bem como a prática
os guia.
...
dos dados colhidos nessa primeira parte, nós levantamos detalhes sobre como a prática influenciou as 
...
using TDD and, based on the gathered data, we retrieved details of how the practice
influenced the developer's class design decisions through
interviews.
...
\include{ape-design}
\include{ape-protocolo-resumido}
