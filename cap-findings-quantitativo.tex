...
\begin{table}[h!]
	...
	\begin{tabular}{ | p{5cm} | p{5cm} | p{5cm} | }
		\hline
		 \textbf{Complexidade Ciclomática} & \textbf{Experiente em TDD} & \textbf{Não experiente em TDD} \\
		\hline
...
\begin{table}[h!]
	...
	\begin{tabular}{ | p{5cm} | p{5cm} | p{5cm} | }
		\hline
		 \textbf{\textit{Fan-Out}} & \textbf{Experiente em TDD} & \textbf{Não experiente em TDD} \\
		\hline
...
\begin{table}[h!]
	...
	\begin{tabular}{ | p{5cm} | p{5cm} | p{5cm} | }
		\hline
		 \textbf{Falta de Coesão nos Métodos} & \textbf{Experiente em TDD} & \textbf{Não experiente em TDD} \\
		\hline
