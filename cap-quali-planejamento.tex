...
Nenhum critério rígido de seleção foi utilizado. Dada a dificuldade de se
...
Para melhor análise futura, os participantes foram avaliados de acordo com
certos critérios:
...
estudo são baseadas nos príncipios catalogados por Martin \ref{bob-martin} e
...
A escolha das métricas foi meramente por conveniência. Como mencionado acima,
as ferramentas existentes não são fáceis de serem utilizadas e, por esse motivo,
selecionamos métricas que poderiam ser facilmente implementadas por nós
a tempo de realizar o estudo.
